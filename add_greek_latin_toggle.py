...
.zodiac-day{text-align:center;line-height:1.2}.zodiac-day .notation-item{display:block;white-space:pre-line}.zodiac-day .zodiac-day-number{display:block;margin:0}.visibility-magnitude{white-space:nowrap}
@media(max-width:760px) and (orientation:portrait){.bayer-toggle-wrap,.notation-legend{padding-left:1rem;padding-right:1rem}.bayer-toggle{justify-content:center;flex-wrap:nowrap;gap:.2rem;font-size:.74rem}.bayer-toggle-label{margin-right:.05rem;white-space:nowrap}.bayer-toggle button{padding:.3rem .42rem;white-space:nowrap}table.calendar th,table.calendar td{padding:.55rem .4rem}table.calendar th:first-child,table.calendar td:first-child{width:22%}table.calendar th:nth-child(2),table.calendar td:nth-child(2){width:22%}table.calendar th:nth-child(3),table.calendar td:nth-child(3){width:56%}table.calendar td:nth-child(2){white-space:normal;text-align:center;font-size:.86rem;overflow-wrap:normal;word-break:normal}}
