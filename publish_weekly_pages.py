...
@media (max-width: 760px) {
  ...
  table.calendar th:first-child, table.calendar td:first-child { width: 30%; min-width: 0; }
  table.calendar th:nth-child(2), table.calendar td:nth-child(2) { width: 15%; min-width: 0; }
  table.calendar th:nth-child(3), table.calendar td:nth-child(3) { width: 55%; min-width: 0; }
  table.calendar td:first-child { white-space: normal; }
  table.calendar td:nth-child(2) { white-space: nowrap; }
  table.calendar td:nth-child(3) { overflow-wrap: anywhere; }
