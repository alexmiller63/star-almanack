...
table.calendar td:first-child { width: 20%; white-space: nowrap; font-weight: 600; }
table.calendar td:nth-child(2) { width: 10%; white-space: nowrap; text-align: center; }
...
@media (max-width: 760px) {
  ...
  table.calendar td:first-child { width: 24%; min-width: 0; white-space: normal; }
  table.calendar td:nth-child(2) { width: 14%; min-width: 0; white-space: nowrap; }
  table.calendar td:nth-child(3) { width: 62%; min-width: 0; overflow-wrap: anywhere; }
